...
const appsyncStack = new AppsyncStack(app, "AppsyncStack", {
  ...
  TodoDB: databaseStack.todosTable,
  userDB: databaseStack.usersTable,
  createTodoFunc: computeStack.createTodoFunc,
  listTodosFunc: computeStack.listTodosFunc,
  deleteTodoFunc: computeStack.deleteTodo,
  updateTodoFunc: computeStack.updateTodo,
});
